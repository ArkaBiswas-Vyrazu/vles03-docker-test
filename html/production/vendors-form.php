<?php include('header.php') ?>
	<div class="right_col" role="main">
		<div class="col-md-12 col-sm-12 col-xs-12">
	        <div class="x_panel">
	          <div class="x_title">
	            <h2>Create New Vendor <small>Users</small></h2>
	          ...
	          <div class="x_content">
	            <form id="general-form">
	              ...
	              <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                <label class="control-label col-md-3 col-sm-3 col-xs-12 text-right" for="company">Company <span class="required">*</span>
	                </label>
	                <div class="col-md-6 col-sm-6 col-xs-12">
	                  <input type="text" id="company" required="required" placeholder="Company" class="form-control col-md-7 col-xs-12">
	                </div>
	              </div>
	              ...
	              <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                <label class="control-label col-md-3 col-sm-3 col-xs-12 text-right" for="admin_info">Admin Info <span class="required">*</span>
	                </label>
	                <div class="col-md-6 col-sm-6 col-xs-12">
	                  <!-- <input type="text" id="city" required="required" placeholder="City" class="form-control col-md-7 col-xs-12"> -->
	                  <textarea class="form-control" id="admin_info" placeholder="Admin Information"></textarea>
	                </div>
	              </div>

	              <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                <label class="control-label col-md-3 col-sm-3 col-xs-12 text-right" for="vendors_comment">Comment <span class="required">*</span>
	                </label>
	                <div class="col-md-6 col-sm-6 col-xs-12">
	                  <!-- <input type="text" id="state" required="required" placeholder="State" class="form-control col-md-7 col-xs-12"> -->
	                  <textarea class="form-control" id="vendors_comment" placeholder="Write here..."></textarea>
	                </div>
	              </div>
