		...
		<div class="col-md-12 col-sm-12 col-xs-12">
	        <div class="x_panel">
	          ...
	          <div class="x_content">
                ...
                <label class="control-label col-md-3 col-sm-3 col-xs-12 text-right">Warehouse Head<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select class="form-control">
	            	...
	            	<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                <label class="control-label col-md-3 col-sm-3 col-xs-12 text-right" for="shortcode">Warehouse Name<span class="required">*</span>
	                </label>
	                <div class="col-md-6 col-sm-6 col-xs-12">
	                  <input type="text" id="shortcode" name="short_code" required="required" placeholder="Warehouse Name" class="form-control col-md-7 col-xs-12">
	                </div>
	              </div>
